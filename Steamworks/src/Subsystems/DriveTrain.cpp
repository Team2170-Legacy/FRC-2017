...
void DriveTrain::InitTalons(void) {
	...
	cANTalonLeft->SetStatusFrameRateMs(CANTalon::StatusFrameRate::StatusFrameRateFeedback, 20);
	cANTalonRight->SetStatusFrameRateMs(CANTalon::StatusFrameRate::StatusFrameRateFeedback, 20);
