...
*/
void GearThree::Process(cv::Mat& source0){
	//Step Resize_Image0:
	//input
	...
	double filterContoursMinRatio = MinRatio;  // default Double
	double filterContoursMaxRatio = MaxRatio;  // default Double
 ...
 */
cv::Mat* GearThree::GetResizeImageOutput(){
 ...
 */
cv::Mat* GearThree::GetHsvThresholdOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* GearThree::GetFindContoursOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* GearThree::GetFilterContoursOutput(){
	 ...
	 */
	void GearThree::resizeImage(cv::Mat &input, double width, double height, int interpolation, cv::Mat &output) {
	 ...
	 * @param output The image in which to store the output.
	 */
	void GearThree::hsvThreshold(cv::Mat &input, double hue[], double sat[], double val[], cv::Mat &out) {
	 ...
	 */
	void GearThree::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
	 ...
	 */
	void GearThree::filterContours(std::vector<std::vector<cv::Point> > &inputContours, double minArea, double minPerimeter, double minWidth, double maxWidth, double minHeight, double maxHeight, double solidity[], double maxVertexCount, double minVertexCount, double minRatio, double maxRatio, std::vector<std::vector<cv::Point> > &output) {
