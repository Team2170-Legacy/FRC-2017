 ...
 */
cv::Mat* GearTwo::GetHslThresholdOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* GearTwo::GetFindContoursOutput(){
...
std::vector<std::vector<cv::Point> >* GearTwo::GetFilterContoursOutput(){
	...
	void GearTwo::hslThreshold(cv::Mat &input, double hue[], double sat[], double lum[], cv::Mat &out) {
	 ...
	 */
	void GearTwo::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
	 ...
	 */
	void GearTwo::filterContours(std::vector<std::vector<cv::Point> > &inputContours, double minArea, double minPerimeter, double minWidth, double maxWidth, double minHeight, double maxHeight, double solidity[], double maxVertexCount, double minVertexCount, double minRatio, double maxRatio, std::vector<std::vector<cv::Point> > &output) {
