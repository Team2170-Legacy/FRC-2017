...
void GearTargetPipeline::Process(cv::Mat& source0){
	...
	double hslThresholdHue[] = {58.45970660364973, 154.5743234426018};
	double hslThresholdSaturation[] = {103.2308103647633, 254.74095719610364};
	double hslThresholdLuminance[] = {43.83410567001908, 173.3085241317085};
	...
	double filterContoursSolidity[] = {0.0, 99.71018577265724};
	...
	double filterContoursMaxRatio = 100000.0;  // default Double
