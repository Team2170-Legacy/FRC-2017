#include "GearTargetPipeline.h"
/**
* Initializes a GearTargetPipeline.
*/

namespace grip {

GearTargetPipeline::GearTargetPipeline() {
}
/**
...
*
*/
void GearTargetPipeline::Process(cv::Mat& source0){
	//Step Resize_Image0:
	//input
	...
	double hslThresholdHue[] = {55.03597122302158, 107.27272727272727};
	double hslThresholdSaturation[] = {59.62230215827338, 197.04545454545453};
	double hslThresholdLuminance[] = {107.77877697841726, 162.70202020202018};
	...
	double filterContoursMinArea = 260.0;  // default Double
 ...
 */
//void GearTargetPipeline::setsource0(cv::Mat &source0){
 ...
 */
cv::Mat* GearTargetPipeline::getresizeImageOutput(){
 ...
 */
cv::Mat* GearTargetPipeline::getblurOutput(){
 ...
 */
cv::Mat* GearTargetPipeline::gethslThresholdOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* GearTargetPipeline::getfindContoursOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* GearTargetPipeline::getfilterContoursOutput(){
	 ...
	 */
	void GearTargetPipeline::resizeImage(cv::Mat &input, double width, double height, int interpolation, cv::Mat &output) {
	 ...
	 * @param output The image in which to store the output.
	 */
	void GearTargetPipeline::blur(cv::Mat &input, BlurType &type, double doubleRadius, cv::Mat &output) {
	...
	void GearTargetPipeline::hslThreshold(cv::Mat &input, double hue[], double sat[], double lum[], cv::Mat &out) {
	 ...
	 */
	void GearTargetPipeline::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
