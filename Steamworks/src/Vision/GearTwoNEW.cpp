...
GearTwoNEW::GearTwoNEW() {
}
/**
* Runs an iteration of the pipeline and updates outputs.
*/
void GearTwoNEW::Process(cv::Mat& source0){
	//Step HSL_Threshold0:
	//input
 ...
 */
cv::Mat* GearTwoNEW::GetHslThresholdOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* GearTwoNEW::GetFindContoursOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* GearTwoNEW::GetFilterContoursOutput(){
	...
	void GearTwoNEW::hslThreshold(cv::Mat &input, double hue[], double sat[], double lum[], cv::Mat &out) {
	 ...
	 */
	void GearTwoNEW::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
	 ...
	 */
	void GearTwoNEW::filterContours(std::vector<std::vector<cv::Point> > &inputContours, double minArea, double minPerimeter, double minWidth, double maxWidth, double minHeight, double maxHeight, double solidity[], double maxVertexCount, double minVertexCount, double minRatio, double maxRatio, std::vector<std::vector<cv::Point> > &output) {
