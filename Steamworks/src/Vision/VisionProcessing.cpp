...
int VisionProcessing::Gear_x;			// Global Gear Target x-location (in 320x240 image coordinates)
int VisionProcessing::e_Gear_x;		// Global variable for error in Gear_x location

int VisionProcessing::BBoiler_x; 		// Global Blue Boiler x-location (in 320x240 image coordinates)
int VisionProcessing::e_BBoiler_x;	// Global variable for error in Gear_x location
...
void VisionProcessing::VisionThread() {
	...
	camera.SetWhiteBalanceManual(5100);
	//usleep(1000000);
