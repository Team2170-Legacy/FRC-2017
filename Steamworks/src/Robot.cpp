...
void Robot::RobotInit() {
	...
	chooser.AddObject("Red Center Peg AND Boiler",
			new AutonomousGearGroup(AutonomousGearGroup::kCenterPegRed, true));
	chooser.AddObject("Blue Center Peg AND Boiler",
			new AutonomousGearGroup(AutonomousGearGroup::kCenterPegBlue, true));
